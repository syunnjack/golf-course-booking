...
const postKey = 'golf-course-booking.posts'
const savedKey = 'golf-course-booking.saved'
const items = [
  {
    "id": "golf-course-booking-1",
    "title": "Nagoya course opportunity",
    "category": "course",
    "area": "Nagoya",
    "summary": "Golf course comparison and booking-intent guide with price, availability, reviews, lodging and practice info. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 92,
    ...
    "revenue": "booking commission"
  },
  {
    "id": "golf-course-booking-2",
    "title": "Tokyo practice range opportunity",
    ...
    "revenue": "stay affiliate"
  },
  {
    "id": "golf-course-booking-3",
    "title": "Osaka stay opportunity",
    "category": "stay",
    "area": "Osaka",
    "summary": "Golf course comparison and booking-intent guide with price, availability, reviews, lodging and practice info. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 78,
...
function App() {
  ...
  const [form, setForm] = useState({ title: '', category: 'course', body: '' })
  ...
  function submitPost(event) {
    ...
    setForm({ title: '', category: 'course', body: '' })
  }
    ...
    <main className="app-shell">
      <section className="hero">
        ...
        <aside className="answer-box">
          ...
          <strong>Golf Course Booking helps users compare, verify and act faster.</strong>
      ...
      <section className="ugc-section">
        ...
        <form className="ugc-form" onSubmit={submitPost}>
          ...
          <select value={form.category} onChange={(event) => setForm({ ...form, category: event.target.value })}>
            {["course","practice range","stay","comp","beginner"].map((item) => <option key={item}>{item}</option>)}
          </select>
